				...
				<div class="col-sm-10 main table-responsive">
					<table id="departments" class="table table-striped">
						...
						<c:forEach items="${departments}" var="department">
							<tr>
								<td>
									<button type="button" class="btn btn-default" onclick="intoDepartmentUI(${department.id})">${department.name}</button>
								</td>
					...
					<c:if test="${grandparentid != null}">
						<button type="button" class="btn btn-primary" id="intoDepartmentUI" onclick="intoDepartmentUI(${grandparentid})">返回上一级
        </button>
					</c:if>

					<!-- Modal -->
					<div class="modal fade" id="addOrEditDialogUI" tabindex="-1" role="dialog" aria-labelledby="modal_title" aria-hidden="true">
